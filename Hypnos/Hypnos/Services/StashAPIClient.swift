...
actor StashAPIClient {
    ...
    /// Fetch a single image by its Stash ID (used by the `hypnos://image?id=`
    ...
    /// Fetch a single scene by its Stash ID (used by the `hypnos://scene?id=`
