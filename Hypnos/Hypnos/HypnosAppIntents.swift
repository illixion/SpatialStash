/*
 ...
 the user instead of opening a main window. "Hey Siri, open a Hypnos
...
// A standalone conformer, not an extension on HypnosApp: the App
// protocol is MainActor-isolated and cannot satisfy this nonisolated protocol
// under Swift 6.
struct HypnosAppIntentsPackage: AppIntentsPackage {
    static var includedPackages: [any AppIntentsPackage.Type] {
        [RAVEUIAppIntentsPackage.self]
    }
}

struct HypnosShortcuts: AppShortcutsProvider {
